...
public class StraightFlushTest {
    ...
    public static void init() {
        ...
        straight1.add(new Card(Value.JACK, Type.CLUB));
        ...
        straight2.add(new Card(Value.TEN, Type.CLUB));
    ...
    public void testEquals() {
        h1 = new StraightFlush(straight1);
        h2 = new StraightFlush(straight1);
    ...
    public void testDifferent() {
        h1 = new StraightFlush(straight1);
        h2 = new StraightFlush(straight2);
